...
const I18N = {
  ...
  dict: {
    ...
    'watch.chat_title': { zh: '直播聊天', en: 'Live chat' },
    'watch.chat_dev': { zh: '直播聊天功能开发中', en: 'Live chat feature in development' },
    'watch.chat_ph': { zh: '发条弹幕…', en: 'Say something…' },
    'watch.chat_send': { zh: '发送', en: 'Send' },
    'watch.chat_login': { zh: '登录后可参与讨论', en: 'Sign in to chat' },
    'watch.chat_empty': { zh: '暂无留言，来抢沙发吧', en: 'No messages yet' },
    'watch.fit_full': { zh: '铺满', en: 'Fill' },
    'watch.fit_full_title': { zh: '裁切铺满画面（可能裁掉边缘）', en: 'Crop to fill (edges may be cut)' },
    'watch.fit_contain_label': { zh: '完整', en: 'Fit' },
    'watch.fit_contain_title': { zh: '完整显示画面（可能有黑边）', en: 'Show full frame (letterbox)' },
